...
public class FSChannel extends Channel {
	...
	private class JoinConferenceState extends State {
		...
		public void processEvent(FSEvent fsEvent) {
			...
			case ConferenceRemoved:{
				...
				FSChannel.this.onEvent(new ConferenceLeftEvent(
						FSChannel.this, cre.getConferenceName(), cre
								.getMemberId()));				
			}
			break;
			}
	...
	public String getCalledNumberFromCallerDestinationNumber(
		...
		return callerDestinationNumber.substring(0, callerDestinationNumber
				.indexOf("@"));
	}
